    ...
    >
      <div className="border-border flex flex-col gap-y-2 border-b p-4">
        <div className="flex flex-row items-center gap-x-2">
          ...
          {title ? (
            <span className="flex-1 truncate text-center text-xs font-medium text-os-dim">
              {title}
            </span>
          ) : null}
        </div>
      </div>
      <pre className={cn("p-4", bodyClassName)}>
        <code className={cn("grid gap-y-1 overflow-auto", codeClassName)}>
          {wrappedChildren}
        </code>
      </pre>
    </div>
